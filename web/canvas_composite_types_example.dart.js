...
$$.main_anon = {"": ["wrapper_0"],
 "super": "Closure",
 call$1: function(compositeType) {
  var canvas, ctx, t1;
  canvas = $.CanvasElement_CanvasElement(125, 125);
  ctx = canvas.get$context2d();
  ctx.set$fillStyle("#09f");
  ctx.fillRect$4(15, 15, 70, 70);
  ctx.set$globalCompositeOperation(compositeType);
  ctx.set$fillStyle("#f30");
  ctx.beginPath$0();
  ctx.arc$6(75, 75, 35, 0, 6.283185307179586, true);
  ctx.fill$0();
  t1 = this.wrapper_0.get$elements();
  $.getInterceptor(t1).add$1(t1, canvas);
}
};
...
$$.main_anon0 = {
 ...
 call$1: function(request) {
  var t1 = request.get$responseText();
  $.query("#code").set$innerHTML(t1);
}
};
...
$.main = function() {
  var compositeTypes, wrapper, t1, t2, t3;
  compositeTypes = ["source-over", "source-in", "source-out", "source-atop", "destination-over", "destination-in", "destination-out", "destination-atop", "lighter", "darker", "copy", "xor"];
  wrapper = $.query("#wrapper");
  $.getInterceptor(compositeTypes).forEach$1(compositeTypes, new $.main_anon(wrapper));
  t1 = wrapper.get$elements();
  t2 = wrapper.get$elements();
  t3 = $.index(t1, $.sub($.getInterceptor(t2).get$length(t2), 1)).get$classes();
  $.getInterceptor(t3).add$1(t3, "last");
  $.HttpRequest_HttpRequest$get("web/canvas_composite_types_example.dart", new $.main_anon0());
};
...
$$ = {};
$.CTC10 = new Isolate.$isolateProperties.Creates("ArrayBuffer|Blob|Document|=Object|=List|String|num");
...
$.$defineNativeClass('CanvasRenderingContext2D', {"": ["fillStyle<", "globalCompositeOperation<"],
...
//@ sourceMappingURL=canvas_composite_types_example.dart.js.map